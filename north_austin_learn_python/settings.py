"""
Django settings for north_austin_learn_python project.
...
ROOT_URLCONF = 'north_austin_learn_python.urls'
...
WSGI_APPLICATION = 'north_austin_learn_python.wsgi.application'
